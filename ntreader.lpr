...
(define-project :name :ntreader
  :modules (list (make-instance 'module :name "ntparser.lisp")
                 (make-instance 'module :name "ntreader.lisp")
                 (make-instance 'module :name "ntadder.lisp")
                 (make-instance 'module :name "angle-bracket-reader.lisp"))
  ...
  :libraries nil
  :editable-files nil
  :distributed-files (list "nt-test.cl" "TESTS/" "test.nt" "all-layers.nt"
                           "all-layers.nq")
